"""
Log Panel widget for HailoRT-Ui.
Displays conversion logs and progress with color-coded output.
"""
...
class LogPanel(QWidget):
    ...
    Provides color-coded log levels, progress tracking,
    ...
    def _export_log(self):
        ...
        default_name = f"hailort_log_{timestamp}.txt"
